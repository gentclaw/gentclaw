...
<p align="center">
  <a href="https://www.npmjs.com/package/gentclaw"><img src="https://img.shields.io/npm/v/gentclaw.svg?style=flat-square" alt="npm"></a>
  ...
  <a href="#quick-start"><img src="https://img.shields.io/badge/node-%3E%3D20-brightgreen" alt="Node ≥20"></a>
...
npm run reload             # rebuild + restart daemon
```

Then configure and run:
```bash
gentclaw setup             # interactive wizard — configures Slack + first agent
gentclaw start             # start Slack listener (foreground)
gentclaw install           # install as OS service (auto-starts on boot)
```
